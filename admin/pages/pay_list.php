...
$sql    = "SELECT mem_name,mem_gender,mem_stunum,mem_phone,mem_pay_check FROM member";
...
<div class="card">
    <div class="card-header">
        <h2 class="card-title">缴费情况列表</h2>
        <small class="card-subtitle">缴费情况列表，可快速检索</small>
    </div>
